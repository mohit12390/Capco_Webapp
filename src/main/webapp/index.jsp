  ...
  <body>
    ...
    <header class="header">
      <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container"><a href="#intro" class="navbar-brand scrollTo">Mohit Portfolio & Special case</a>
    ...
    <section id="intro" style="background: url(img/home.jpg) center center no-repeat; background-size: cover;" class="intro-section pb-2">
      <div class="container text-center">
        <div data-animate="fadeInDown" class="logo"><img src="img/logo-big.png" alt="logo" width="130"></div>
         <h1 data-animate="fadeInDown" class="text-shadow mb-5">Hello Recruiter!</h1>
        <p data-animate="slideInUp" class="h3 text-shadow text-20">
          I am an active contributor to the Java project, helping build starter Web Apps used by Html5 and Bootstrap with Jquery .</p>
      <p data-animate="slideInUp" class="h3 text-shadow text-20">Highly skilled software professional in
developing web applications and server side J2EE development using Servlet,
JSP, Spring technologies </p>
            <p data-animate="slideInUp" class="h3 text-shadow text-20">
         Specialities : JAVA,SPRING MVC,ORACLE,
     DEVOPS,GIT,UNIX,REST,INFORMATICA</p>
      </div>
    </section>
    <!-- About-->
      ...
      <div class="container">
        ...
        <div class="row">
          <div data-animate="fadeInUp" class="col-lg-6">
            <p>Mohit is basically from Bengaluru, India working on Java Developer  </p>
      		<p>Mohit is a multi-linguist in technology-driven business. He speaks fluent geek and have good ideas for Logics Of Java Developer </p>  
      		<p>Specialities : JAVA,SPRING MVC,ORACLE,DEVOPS,GIT,UNIX,REST,INFORMATICA</p>
      		<p>Working Technology :JAVA,SPRING MVC,ORACLE,DEVOPS,GIT,UNIX,REST,INFORMATICA</p>
          ...
          <div data-animate="fadeInUp" class="col-lg-6">
            <div class="skill-item">
              ...
              <div class="progress">
                <div role="progressbar" style="width: 80%" aria-valuenow="0" aria-valuemin="80" aria-valuemax="100" class="progress-bar progress-bar-skill1"></div>
              </div>
            </div>
            <div class="skill-item">
              <div class="progress-title">UNIX</div>
              <div class="progress">
                <div role="progressbar" style="width: 90%" aria-valuenow="70" aria-valuemin="60" aria-valuemax="100" class="progress-bar progress-bar-skill2"></div>
              </div>
            </div>
            <div class="skill-item">
              <div class="progress-title">Shell Script</div>
              <div class="progress">
                <div role="progressbar" style="width: 70%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" class="progress-bar progress-bar-skill3"></div>
              </div>
            </div>
            <div class="skill-item">
              <div class="progress-title">Spring MVC</div>
              <div class="progress">
            ...
            <div class="skill-item">
              <div class="progress-title">Oracle</div>
              <div class="progress">
                <div role="progressbar" style="width: 85%" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" class="progress-bar progress-bar-skill5"></div>
              </div>
            </div>
            <div class="skill-item">
              <div class="progress-title">DEVOPS</div>
              <div class="progress">
                <div role="progressbar" style="width: 65%" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" class="progress-bar progress-bar-skill5"></div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row services text-center">
          <div data-animate="fadeInUp" class="col-lg-4">
            ...
            <p class="text-left description">Information technology consulting (also called IT consulting, computer consultancy, business and technology services, computing consultancy, technology consulting, and IT advisory) as a field of activity focuses on advising organizations on how best to use information technology (IT) in achieving their business objectives.</p>
          </div>
          <div data-animate="fadeInUp" class="col-lg-4">
            <div class="icon"><i class="fa fa-html5"></i></div>
            <h3 class="heading mb-3 text-400">Shell Scripting coding</h3>
            <p class="text-left description">shell script is a computer program designed to be run by the Unix shell, a command-line interpreter.The various dialects of shell scripts are considered to be scripting languages. Typical operations performed by shell scripts include file manipulation, program execution, and printing text. A script which sets up the environment, runs the program, and does any necessary cleanup, logging</p>
          </div>
          <div data-animate="fadeInUp" class="col-lg-4">
            <div class="icon"><i class="fa fa-tachometer"></i></div>
            <h3 class="heading mb-3 text-400">Java web development</h3>
            <p class="text-left description">Web application or web app is a client–server computer program which the client (including the user interface and client-side logic) runs in a web browser. Common web applications include webmail, online retail sales, online auction.
            web applications is often simplified by the use of web application frameworks such as Django, Ruby on Rails, and Symfony. These frameworks facilitate rapid application development by allowing a development team to focus on the parts of their application which are unique to their goals without having to resolve common development issues such as user management.</p>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="messages"></div>
              <div class="controls">
                <div class="row">
                  <div class="col-md-6">
                     <input type="text" name="fname" placeholder="Your firstname *" class="form-control" >
                   </div>
                  <div class="col-md-6">
                          <input type="text" name="sname" placeholder="Your lastname *" class="form-control" >
                  </div>
                  <div class="col-md-6">
                          <input type="text" name="email" placeholder="Your Email *" class="form-control" >
                  </div>
                  <div class="col-md-6">
                         <input type="text" name="phone" placeholder="Your Contact No. *" class="form-control" >
                  </div>
                  <div class="col-md-12">
                    <textarea name="message" placeholder="Message for me *" rows="4" required="true" class="form-control" ></textarea>
                  </div>
   ...
   <p align="center">   <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.9541909832724!2d77.62094811430383!3d12.910665819706836!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae14ee38a7dbc9%3A0x36a36de31f2328a5!2z4LC14LCC4LCm4LCoIOCwquCxjeCwr-CwvuCwsOCwoeCxiOCwnOCxjSDgsIXgsKrgsL7gsLDgsY3gsJ_gsY3gsK7gsYbgsILgsJ_gsY3gsLjgsY0!5e0!3m2!1ste!2sin!4v1620281057541!5m2!1ste!2sin" width="900" height="300" style="border:0;" allowfullscreen="" loading="lazy"></iframe> </p>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 text-center text-lg-right mt-4 mt-lg-0">
            <p>© 2018 Mohit Gangil All rights reserved.</p>
          </div>
          <div class="col-12 mt-4">
            <p class="template-bootstrapious">Designed by <a href="https://www.bootstrapious.com">Mohit Gangil</a>
...
function validateForm()
 {
   var x = document.forms["myForm"]["fname"].value;
    ...
    {
      alert("form submitted Successfully!, Please check your email " + a);
    }
}
</script>
